...
<%
	...
	List<String> cart = new Vector<String>();
	String username="";
	if(cookies != null){
...
<body>
	...
	<fieldset>
		...
		<form
			method="post"
			action="CookieExamLoginProcess.jsp"
		>
			<table
				...
				<tr style="background-color: white">
					...
					<td>
						<input
							...
							name="user"
							value=
							'<%=request.getParameter("user")==null?username:request.getParameter("user") %>'
						/> <input
							type="checkbox"
							name="idsave"
							value="Y"
