...
<body>
	<fieldset>
		...
		<%= request.getAttribute("USER_ID")==null?"":request.getAttribute("USER_ID") %>
		<%= request.getAttribute("USER_PWD")==null?"":request.getAttribute("USER_PWD") %>
		</span>
	</fieldset>
</body>
</html>