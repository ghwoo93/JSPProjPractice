...
// 	 ctx = (Context)ctx.lookup(application.getInitParameter("JNDI_ROOT"));
	 /* 
	  3]context.xml에 등록한 네이밍을 lookup
	    -톰캣의 context.xml에 등록한 네이밍으로 DataSource를 얻는다 
	*/
// 	DataSource ds = (DataSource)ctx.lookup("jsp");
	//풀 경로로 접근하기
// 	DataSource source = (DataSource)ctx.lookup(application.getInitParameter("JNDI_ROOT")+"/jsp");
